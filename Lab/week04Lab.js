...
let myName = "Logan"
let friendsName = "Hannah"


//Question: Name a reason why you would use const instead of let.
//Answer: Maybe you want the food to stay the same but the people eating may be changed?
...
console.log(`${friendsName} & I are eating lunch today downtown.
We will be having ${toEat} with ${toDrink} to drink.`);
...
//Answer: console.log(friendsName + " " + "& I are eating lunch today downtown. /nWe will be having" + " " + toEat + " " + "with" + " " + toDrink + " " + "to drink");
...
//Answer: It means that this has already been set to a value that is not to be changed through reassignment.
...
const lunchTime = (foodChoice, drinkChoice) => {
   return `${friendsName} & I are eating lunch today downtown.
   We will be having ${foodChoice} with ${drinkChoice} to drink.`;
}
...
//             return  friendsName + " " + "& I are eating lunch today downtown. We will be having" + " " + foodChoice + " " + "with" + " " + drinkChoice + " " + "to drink."  
//          }
//          console.log(lunchTime('Pizza', 'Water'));
...
console.log(foodForTodayAndTomorrow('Pasta','Coke',lunchTime('Pizza', 'Water')));
